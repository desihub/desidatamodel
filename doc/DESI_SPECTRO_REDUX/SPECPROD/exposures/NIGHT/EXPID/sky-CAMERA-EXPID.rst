...
.. collapse:: Required Header Keywords Table
    ...
    CRYOPRES 9.252e-08                                                             str   [mb] Cryostat pressure (IP)
    ...
    FIBERMIN 3000                                                                  int
    BBKGMINA -0.2077800596230136                                                   float
    BBKGMAXA 0.5254324469128164                                                    float
    BBKGMINB -0.2033242713025349                                                   float
    BBKGMAXB 0.4258502359052168                                                    float
    BBKGMINC -0.1314577356495719                                                   float
    BBKGMAXC 0.4236035445727393                                                    float
    BBKGMIND -0.2582211042496522                                                   float
    BBKGMAXD 0.3659635169905933                                                    float
