...
:Naming Convention: ``zcatalog/v2/zall/zall-pix-{SPECPROD}.fits``, where ``{SPECPROD}`` is the
...
:doc:`zpix-*.fits <../SURVEY/zpix-SURVEY-PROGRAM>` core files, combining redshift
...
:doc:`zpix-SURVEY-PROGRAM.fits <../SURVEY/zpix-SURVEY-PROGRAM>` files.
