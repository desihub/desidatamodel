...
:Summary: Concatenation of all ``ztile-*-cumulative.fits`` files, combining
          ...
          PROGRAMs.
:Naming Convention: ``zall-tilecumulative-{SPECPROD}.fits``, where ``{SPECPROD}``
...
:doc:`ztile-*-cumulative.fits <./ztile-SURVEY-PROGRAM-GROUPTYPE>` core files,
...
:doc:`ztile-SURVEY-PROGRAM-GROUPTYPE.fits <./ztile-SURVEY-PROGRAM-GROUPTYPE>`
cumulative files.
