...
:Naming Convention: ``spectra-8-80606-1xsubset3.fits``, where ... *Give a human readable
    description of the filename, e.g. ``blat-{EXPID}`` where ``{EXPID}``
    is the 8-digit exposure ID.*
:Regex: ``spectra-8-80606-1xsubset3.fits`` *Give a regular expression for this filename.
    For example, a six-digit number would correspond to ``[0-9]{6}``.*
:File Type: FITS, 593 MB  *This section gives the type of the file
...
======== ================ ==== ==============================================
CHECKSUM bWVRbUTObUTObUTO str  HDU checksum updated 2021-07-30T15:08:55
DATASUM  0                str  data unit checksum updated 2021-07-30T15:08:55
======== ================ ==== ==============================================
...
KEY      Example Value    Type Comment
======== ================ ==== ==============================================
NAXIS1   425              int  length of dimension 1
NAXIS2   1500             int  length of dimension 2
CHECKSUM Sd6FVc49Sc4CSc49 str  HDU checksum updated 2021-07-30T15:08:55
DATASUM  3308870880       str  data unit checksum updated 2021-07-30T15:08:55
======== ================ ==== ==============================================
...
NAXIS2 1500          int  number of rows in table
====== ============= ==== =======================
...
====== ============================ ==== =====================
NAXIS1 2751                         int  length of data axis 1
NAXIS2 1500                         int  length of data axis 2
BUNIT  10**-17 erg/(s cm2 Angstrom) str
====== ============================ ==== =====================

Data: FITS image [float32, 2751x1500]
...
Data: FITS image [int32 (compressed), 2751x1500]
...
NAXIS3 1500          int  length of data axis 3
====== ============= ==== =====================

Data: FITS image [float32, 2751x11x1500]
...
Data: FITS image [float32, 2326x1500]
...
Data: FITS image [int32 (compressed), 2326x1500]
...
Data: FITS image [float32, 2326x11x1500]
...
Data: FITS image [float32, 2881x1500]
...
Data: FITS image [int32 (compressed), 2881x1500]
...
Data: FITS image [float32, 2881x11x1500]
