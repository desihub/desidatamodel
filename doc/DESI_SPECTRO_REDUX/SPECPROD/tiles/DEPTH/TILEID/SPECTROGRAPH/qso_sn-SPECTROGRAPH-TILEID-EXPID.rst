...
:Naming Convention: ``qso_qn-2-80609-1xsubset6.fits``, where ... *Give a human readable
    description of the filename, e.g. ``blat-{EXPID}`` where ``{EXPID}``
    is the 8-digit exposure ID.*
:Regex: ``qso_qn-2-80609-1xsubset6.fits`` *Give a regular expression for this filename.
...
NAXIS2 120           int  number of rows in table
====== ============= ==== =======================
