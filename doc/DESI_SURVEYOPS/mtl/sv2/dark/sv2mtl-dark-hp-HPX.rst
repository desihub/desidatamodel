...
:Naming Convention: ``sv2mtl-dark-hp-HPX.ecsv``, where
    HPX is the nside=32 (NESTED) HEALPixel integer.
:Regex: ``sv2mtl-dark-hp-[0-12287]\.ecsv``
:File Type: ecsv, 2-3 MB
...
INDIR    dr9/0.53.0/targets/sv2/resolve/dark/ str  Location of the directory of targets used to produce the file
