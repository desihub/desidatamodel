====================
sv2mtl-bright-hp-HPX
====================

:Summary: MTL ledgers for the DESI bright-time program.
:Naming Convention: ``sv2mtl-bright-hp-HPX.ecsv``, where
    HPX is the nside=32 (NESTED) HEALPixel integer.
:Regex: ``sv2mtl-bright-hp-[0-12287]\.ecsv``
:File Type: ecsv, 1-2 MB
...
INDIR    dr9/0.53.0/targets/sv2/resolve/bright/ str  Location of the directory of targets used to produce the file
