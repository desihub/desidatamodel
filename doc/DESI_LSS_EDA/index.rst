...
(including weights). The canonical location is ``$DESI_ROOT/survey/catalogs/eda_prep/_RELEASE_``, with the 
...
directory will be copied to `/global/cfs/cdirs/desi/public/edr/vac/LSS/sv3v1`. We will negotiate sym-links as 
