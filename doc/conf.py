...
latex_documents = [
  ('index', 'desidatamodel.tex', u'desidatamodel Documentation',
   u'DESI', 'manual'),
]
...
man_pages = [
    ('index', 'desidatamodel', u'desidatamodel Documentation',
     [u'DESI'], 1)
]
...
texinfo_documents = [
  ('index', 'desidatamodel', u'desidatamodel Documentation',
   u'DESI', 'desidatamodel', 'One line description of project.',
   'Miscellaneous'),
]
