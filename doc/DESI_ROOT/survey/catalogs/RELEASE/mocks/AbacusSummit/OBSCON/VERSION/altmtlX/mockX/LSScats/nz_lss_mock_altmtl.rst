========================================
n(z) for AltMTL Mock clustering catalogs
========================================

:Summary: Contains target densities, as a function of redshift.
:Naming Convention: ``{TARGET}_nz.txt``, where ``{TARGET}`` is ``QSO``, ``ELG_LOPnotqso``, ``LRG``, for dark or ``BGS_ANY``, ``BGS_BRIGHT``, ``BGS_BRIGHT-21.5``, for bright. 
:Regex: ``[A-Za-z0-9._+-]+_nz.txt``
:File Type: ASCII
