...
INDIR    dr9/0.57.0/targets/sv3/secondary/dark str  Location of the directory of targets used to produce the file
...
TARGET_STATE      char[15]        Combination of target's class and its current observational state
