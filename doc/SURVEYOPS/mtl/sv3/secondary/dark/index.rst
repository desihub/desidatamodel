...
The filename for each ledger resembles sv3mtl-dark-hp-HPX.ecsv, where HPX
is the healpixel number.

.. toctree::
   :maxdepth: 1

   sv3mtl-dark-hp-HPX.ecsv : MTL ledgers for the DESI dark-time program (secondary targets) <sv3mtl-dark-hp-HPX>
